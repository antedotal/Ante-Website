...
export function Footer() {
  return (
    <footer className="min-h-[50vh] bg-(--color-primary) text-white flex flex-col justify-between p-8 md:p-16 overflow-hidden relative">
      <div className="flex flex-col md:flex-row justify-between items-start w-full z-10">
        <div className="flex flex-col">
          <div className="text-[15vw] leading-[0.8] font-bold tracking-tighter font-sans-flex font-immersive">Ante</div>
          <div className="text-xl md:text-2xl font-light opacity-80 ml-2 mt-4 font-sans-flex font-immersive">by antedotal</div>
        </div>
        ...
        <div className="flex flex-col gap-5 mt-12 md:mt-0 text-lg font-medium">
          <div className="flex items-center gap-3">
            <a
              ...
              className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all backdrop-blur-xl border border-white/20 font-immersive"
            >
