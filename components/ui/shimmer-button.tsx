...
>(
  (
    ...
    const sharedClassName = cn(
      ...
      "transform-gpu transition-transform duration-300 ease-in-out active:translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50",
      className
    )
